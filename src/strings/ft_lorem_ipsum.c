...
/*   Updated: 2015/10/05 18:20:22 by ntrancha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/libft.h"

char		ft_straddstr(char **dst, char *str)
{
	ft_strfusion(dst, &str);
}

char		*lorem_ipsum(void)
{
	char	*ret;
...
void		add_random(char **str, int *size)
{
	*size -= 10;
