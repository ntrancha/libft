...
/*   Updated: 2015/01/13 12:53:13 by ntrancha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	test_itoa(void)
{
	...
	//ft_putendl(ft_itoa(-123));
	//ft_putendl(ft_itoa(5460));
	//ft_putendl(ft_itoa(-4656));
	...
	//PUT_ENDL;
	//ft_putnbr(atoi("922337203685477580899"));
	//PUT_ENDL;
	//ft_putnbr(ft_atoi("922337203685477580899"));
	//PUT_ENDL;
...
static void	test_strnequ(void)
{
	...
	ft_putnbr(ft_strnequ("test string", "test string", 3));
	PUT_ENDL;
	//ft_putnbr(memcmp("test string", "test string", 3));
	PUT_ENDL;
	ft_putnbr(ft_strnequ("test string", "test string", 30));
	PUT_ENDL;
	ft_putnbr(ft_strnequ(NULL, NULL, 30));
	PUT_ENDL;
	//ft_putnbr(memcmp("test string", "test string", 3));
	//PUT_ENDL;
#ifdef SEGFAULT_ME
