...
UT_TEST(ft_atoi)
{
	...
	ft_putstr("-9223372036854775807 ft:");
	ft_putnbr(ft_atoi("-9223372036854775807"));
	PUT_ENDL;
	ft_putstr(":");
	ft_putnbr(atoi("-9223372036854775807"));
	PUT_ENDL;
	ft_putstr("-9223372036854775806 ft:");
	ft_putnbr(ft_atoi("-9223372036854775806"));
	PUT_ENDL;
	ft_putstr(":");
	ft_putnbr(atoi("-9223372036854775806"));
	PUT_ENDL;
	ft_putstr("-2398472983749236582739823758723469826928374 ft:");
	ft_putnbr(ft_atoi("-2398472983749236582739823758723469826928374"));
	PUT_ENDL;
	ft_putstr(":");
	ft_putnbr(atoi("-2398472983749236582739823758723469826928374"));
	PUT_ENDL;
	UT_ASSERT_EQ(ft_atoi("9223372036854775807"), atoi("9223372036854775807"));
